...
class ToolAttr(object):
    def __init__(self):
        self.label = "Export Attributes"
        self.description = "Export the attributes (columns) of a dataset to TSV"
    ...
    def getParameterInfo(self):
        ...
        params.append(arcpy.Parameter(name = "output", displayName = "Output TSV file", direction = "Output", datatype = "File", parameterType = "Required"))
        return params
...
class ToolFeat(object):
    def __init__(self):
        ...
        self.description = "Export the features of a dataset to TSV"
        self.canRunInBackground = True
